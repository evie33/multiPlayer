...
/* harmony import */ var _dist_diffy_min_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1);
...
const socket = socket_io_client__WEBPACK_IMPORTED_MODULE_1___default()(window.location.origin);
...
const diffy = Object(_dist_diffy_min_js__WEBPACK_IMPORTED_MODULE_0__["create"])({
...
!function (e, t) {
  ...
  return function (e) {
    ...
    function n(e, t) {
      ...
      function e(t) {
        var i = t.tickFn,
            ...
            p = t.debug,
            g = void 0 !== p && p,
            m = t.sourceDimensions,
            w = void 0 === m ? { w: 130, h: 100 } : m,
            b = t.onFrame,
      ...
      }return r(e, [{ key: "toVideo", value: function (e, t) {
          t.src = e;
        } }, { key: "toCanvas", value: function (e, t) {
          t.getContext("2d").drawImage(e, 0, 0, t.width, t.height);
        } }, { key: "mirror", value: function (e) {
          var t = e.getContext("2d");return t.translate(e.width, 0), t.scale(-1, 1), e;
        } }, { key: "compare", value: function (e, t) {
          var i = e.data,
              n = t.data,
              r = i.length,
              o = new ArrayBuffer(r);this.worker.postMessage({ buffer: o, data1: i, data2: n, sensitivity: this.sensitivity, threshold: this.threshold, width: this.sourceWidth, height: this.sourceHeight });
        } }, { key: "drawBlendImageFromBuffer", value: function (e) {
        ...
        } }, { key: "createMatrix", value: function () {
          var e = void 0,
              t = void 0,
              i = 0,
              n = [],
              r = this.sourceWidth,
              o = this.sourceHeight,
              a = this.sourceWidth / this.resolutionX,
              s = this.sourceHeight / this.resolutionY,
              d = null,
              u = void 0,
              l = void 0,
              c = 0;for (e = 0; e < r; e += a) {
            var h = [];for (t = 0; t < o; t += s) {
              for (d = this.blendCanvasCtx.getImageData(e, t, a, s).data, u = d.length, l = u / 4; i < l;) c += (d[4 * i] + d[4 * i + 1] + d[4 * i + 2]) / 3, ++i;c = this.roundFn(c / l), h.push(c), c = 0, i = 0;
            }n.push(h);
          }return n;
        ...
        } }, { key: "createElements", value: function (e) {
        ...
        } }, { key: "injectCssStyles", value: function () {
    ...
    Object.defineProperty(t, "__esModule", { value: !0 });var n = function (e, t, i) {
      var n = navigator.getUserMedia || navigator.webkitGetUserMedia || navigator.mozGetUserMedia;return n ? new Promise(function (t, i) {
        n.call(navigator, e, t, i);
      }) : Promise.reject(new Error("getUserMedia is not implemented in this browser"));
    };void 0 === navigator.mediaDevices && (navigator.mediaDevices = {}), void 0 === navigator.mediaDevices.getUserMedia && (navigator.mediaDevices.getUserMedia = n);var r = function (e) {
...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(36)(module), __webpack_require__(4)))
